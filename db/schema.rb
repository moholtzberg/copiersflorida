...
ActiveRecord::Schema.define(version: 20150312032722) do
  ...
  create_table "message_settings", force: :cascade do |t|
    t.integer  "store_id"
    t.string   "name"
    t.string   "address"
    t.string   "city"
  ...
  add_index "spree_products_stores", ["product_id"], name: "index_spree_products_stores_on_product_id"
  add_index "spree_products_stores", ["store_id"], name: "index_spree_products_stores_on_store_id"
  ...
  create_table "spree_taxon_maps", force: :cascade do |t|
    t.integer  "taxon_id"
